  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Parcourez toutes les recettes disponibles sur VeggieFest et utilisez nos filtres pour trouver des idées de recettes facilement !'
        />
      ...
      <main className={styles.main}>
        ...
        {!isLoading && isFiltered && arrToMap.length === 0 ? (
          <p className={styles.emptyState}>
            Nous n‘avons malheureusement pas de recette correspondant à ces critères 😔
            <br /> Essayez de modifier vos critères pour découvrir d‘autres recettes !
          </p>
        ) : null}
      </main>
    </>
